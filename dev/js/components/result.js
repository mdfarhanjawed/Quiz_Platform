        ...
        <table className="vitamins">
          ...
          <tbody>
            <tr>
              ...
              <td><Link className='ViewDetailStyle' to="/view_details" onClick={(e) => { this.props.view_details({user_id: localStorage.getItem('user_id'), question_type: "QUANTATIVE"})}}>Details</Link>  </td>
            </tr>
            <tr>
              <td>Reasoning</td>
              ...
              <td><Link className='ViewDetailStyle' to="/view_details" onClick={(e) => { this.props.view_details({user_id: localStorage.getItem('user_id'), question_type: "REASONING"})}}>Details</Link></td>
            </tr>
            <tr>
              <td>English</td>
              ...
              <td><Link className='ViewDetailStyle' to="/view_details" onClick={(e) => { this.props.view_details({user_id: localStorage.getItem('user_id'), question_type: "ENGLISH"})}}>Details</Link></td>
            </tr>
          </tbody>
        </table>
